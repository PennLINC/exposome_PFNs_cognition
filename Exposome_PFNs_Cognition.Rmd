...
png("/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/Figures/ExpFactor_PicVocab_Disc.png",
    width = 2600, 
    height = 3100,
    res=800)
...
png("/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/Figures/ExpFactor_Flanker_Disc.png",
    width = 2600, 
    height = 3100,
    res=800)
...
png("/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/Figures/ExpFactor_Picture_Disc.png",
    width = 2600, 
    height = 3100,
    res=800)
...
png("/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/Figures/ExpFactor_Pattern_Disc.png",
    width = 2600, 
    height = 3100,
    res=800)
...
png("/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/Figures/ExpFactor_Reading_Disc.png",
    width = 2600, 
    height = 3100,
    res=800)
...
png("/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/Figures/ExpFactor_PicVocab_Rep.png",
    width = 2600, 
    height = 3100,
    res=800)
...
png("/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/Figures/ExpFactor_Flanker_Rep.png",
    width = 2600, 
    height = 3100,
    res=800)
...
png("/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/Figures/ExpFactor_Picture_Rep.png",
    width = 2600, 
    height = 3100,
    res=800)
...
png("/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/Figures/ExpFactor_Pattern_Rep.png",
    width = 2600, 
    height = 3100,
    res=800)
...
png("/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/Figures/ExpFactor_Reading_Rep.png",
    width = 2600, 
    height = 3100,
    res=800)
...
# Next, relate exposome factors to PFN topography at Time 0
```{r}
...
# Remove participants based on quality control from ABCD
...
# Add mean FD (fractional displacement is a measurement of head motion)
...
# Linear mixed effects mdoels to relate PFN topography to Exp-Factor
mod11<-lmer(General_SES~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+PFN1+PFN2+PFN3+PFN4+PFN5+PFN6+PFN7+PFN8+PFN9+PFN10+PFN11+PFN12+PFN13+PFN14+PFN15+PFN16+PFN17,data=abcd.data.disc.pfns)
mod12<-lmer(General_SES~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+PFN1+PFN2+PFN3+PFN4+PFN5+PFN6+PFN7+PFN8+PFN9+PFN10+PFN11+PFN12+PFN13+PFN14+PFN15+PFN16+PFN17,data=abcd.data.rep.pfns)

tab_model(mod11,mod12,pred.labels = c("Intercept","Age","Sex","Motion","PFN1","PFN2","PFN3","PFN4","PFN5","PFN6","PFN7","PFN8","PFN9","PFN10","PFN11","PFN12","PFN13","PFN14","PFN15","PFN16","PFN17"),dv.labels=c("General SES (Disc)","General SES (Rep)"),digits=2,digits.p=2,show.se=TRUE,show.stat=TRUE,string.stat = "t",string.se = "Std. Error",show.intercept=TRUE,show.ci = FALSE, p.adjust="bonferroni",p.style="scientific", file = "/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/PFNs_ExpBifactor_DiscRep.doc")


# Specifically test associations with the total cortical rep of the three fronto-parietal networks (3, 15, 17)
...
mod13<-lmer(FPN~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+General_SES,data=abcd.data.disc.pfns)
mod14<-lmer(FPN~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+General_SES,data=abcd.data.rep.pfns)

mod21<-lmer(PicVocab~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN,data=abcd.data.disc.pfns)
mod31<-lmer(PicVocab~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN,data=abcd.data.rep.pfns)
mod22<-lmer(Flanker~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN,data=abcd.data.disc.pfns)
mod32<-lmer(Flanker~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN,data=abcd.data.rep.pfns)
mod23<-lmer(Picture~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN,data=abcd.data.disc.pfns)
mod33<-lmer(Picture~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN,data=abcd.data.rep.pfns)
mod24<-lmer(Pattern~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN,data=abcd.data.disc.pfns)
mod34<-lmer(Pattern~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN,data=abcd.data.rep.pfns)
mod25<-lmer(Reading~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN,data=abcd.data.disc.pfns)
mod35<-lmer(Reading~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN,data=abcd.data.rep.pfns)


tab_model(mod13,mod14,pred.labels = c("Intercept","Age","Sex","Motion","General SES"),dv.labels=c("FPN (Disc)","FPN (Rep)"),digits=2,digits.p=2,show.se=TRUE,show.stat=TRUE,string.stat = "t",string.se = "Std. Error",show.intercept=TRUE,show.ci = FALSE, p.adjust="bonferroni",p.style="scientific", file = "/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/FPN_ExpBifactor_DiscRep.doc")

tab_model(mod21,mod22,mod23,mod24,mod25,pred.labels = c("Intercept","Age","Sex","Motion","FPN"),dv.labels=c("PicVocab","Flanker","Picture","Pattern","Reading"),digits=2,digits.p=2,show.se=TRUE,show.stat=TRUE,string.stat = "t",string.se = "Std. Error",show.intercept=TRUE,show.ci = FALSE, p.adjust="bonferroni",p.style="scientific", file = "/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/FPN_Cognition_Disc.doc")

tab_model(mod31,mod32,mod33,mod34,mod35,pred.labels = c("Intercept","Age","Sex","Motion","FPN"),dv.labels=c("PicVocab","Flanker","Picture","Pattern","Reading"),digits=2,digits.p=2,show.se=TRUE,show.stat=TRUE,string.stat = "t",string.se = "Std. Error",show.intercept=TRUE,show.ci = FALSE, p.adjust="bonferroni",p.style="scientific", file = "/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/FPN_Cognition_Rep.doc")


# MEDIATION TEST:
summary(lmer(PicVocab~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+General_SES,data=abcd.data.disc.pfns))
summary(lmer(PicVocab~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN+General_SES,data=abcd.data.disc.pfns))

bs_indir = c()
for (i in 1:1000){
  thisSample <- sample(c(1:length(abcd.data.disc.pfns$subjectkey)),length(abcd.data.disc.pfns$subjectkey),replace=TRUE)
  pathc<-lmer(PicVocab~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+General_SES,data=abcd.data.disc.pfns[thisSample,])
  pathcp<-lmer(PicVocab~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN+General_SES,data=abcd.data.disc.pfns[thisSample,])
  indir<-fixef(pathc)[5]-fixef(pathcp)[6]
  bs_indir <- c(bs_indir,indir)
}
t.test(bs_indir,conf.level=0.95)
#t = 21.753, df = 999, p-value < 2.2e-16
# alternative hypothesis: true mean is not equal to 0
# 95 percent confidence interval:
#  0.001433320 0.001717562
# sample estimates:
#   mean of x 
# 0.001575441

summary(lmer(Reading~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+General_SES,data=abcd.data.disc.pfns))
summary(lmer(Reading~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN+General_SES,data=abcd.data.disc.pfns))

bs_indir = c()
for (i in 1:1000){
  thisSample <- sample(c(1:length(abcd.data.disc.pfns$subjectkey)),length(abcd.data.disc.pfns$subjectkey),replace=TRUE)
  pathc<-lmer(Reading~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+General_SES,data=abcd.data.disc.pfns[thisSample,])
  pathcp<-lmer(Reading~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN+General_SES,data=abcd.data.disc.pfns[thisSample,])
  indir<-fixef(pathc)[5]-fixef(pathcp)[6]
  bs_indir <- c(bs_indir,indir)
}
t.test(bs_indir,conf.level=0.95)
# t = -14.107, df = 999, p-value < 2.2e-16
# alternative hypothesis: true mean is not equal to 0
# 95 percent confidence interval:
#  -0.0012803072 -0.0009676044
# sample estimates:
#    mean of x 
# -0.001123956 


summary(lmer(PicVocab~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+General_SES,data=abcd.data.rep.pfns))
summary(lmer(PicVocab~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN+General_SES,data=abcd.data.rep.pfns))

bs_indir = c()
for (i in 1:1000){
  thisSample <- sample(c(1:length(abcd.data.rep.pfns$subjectkey)),length(abcd.data.rep.pfns$subjectkey),replace=TRUE)
  pathc<-lmer(PicVocab~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+General_SES,data=abcd.data.rep.pfns[thisSample,])
  pathcp<-lmer(PicVocab~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN+General_SES,data=abcd.data.rep.pfns[thisSample,])
  indir<-fixef(pathc)[5]-fixef(pathcp)[6]
  bs_indir <- c(bs_indir,indir)
}
t.test(bs_indir,conf.level=0.95)
# t = 28.553, df = 999, p-value < 2.2e-16
# alternative hypothesis: true mean is not equal to 0
# 95 percent confidence interval:
#  0.001932957 0.002218251
# sample estimates:
#   mean of x 
# 0.002075604 


summary(lmer(Reading~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+General_SES,data=abcd.data.rep.pfns))
summary(lmer(Reading~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN+General_SES,data=abcd.data.rep.pfns))

bs_indir = c()
for (i in 1:1000){
  thisSample <- sample(c(1:length(abcd.data.rep.pfns$subjectkey)),length(abcd.data.rep.pfns$subjectkey),replace=TRUE)
  pathc<-lmer(Reading~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+General_SES,data=abcd.data.rep.pfns[thisSample,])
  pathcp<-lmer(Reading~interview_age+sex_at_birth+(1|rel_family_id)+(1|abcd_site)+meanFD+FPN+General_SES,data=abcd.data.rep.pfns[thisSample,])
  indir<-fixef(pathc)[5]-fixef(pathcp)[6]
  bs_indir <- c(bs_indir,indir)
}
t.test(bs_indir,conf.level=0.95)
# t = 55.629, df = 999, p-value < 2.2e-16
# alternative hypothesis: true mean is not equal to 0
# 95 percent confidence interval:
#  0.004739170 0.005085749
# sample estimates:
#   mean of x 
# 0.004912459
...
# Make some plots:
png("/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/Figures/ExpFactor_FPN_Disc.png",
    width = 2400, 
    height = 3100,
    res=800)
ggplot(data=abcd.data.disc.pfns,aes(General_SES,FPN))+geom_point(size=0.4,colour='goldenrod2')+geom_smooth(method=lm,colour='black')+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black")) +ylab('FPN Topography') + xlab('Exp-Factor') +coord_cartesian(xlim = c(-3.25,3.25))
dev.off() 

png("/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/Figures/ExpFactor_FPN_Rep.png",
    width = 2400, 
    height = 3100,
    res=800)
ggplot(data=abcd.data.rep.pfns,aes(General_SES,FPN))+geom_point(size=0.4,colour='goldenrod2')+geom_smooth(method=lm,colour='black')+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black")) +ylab('FPN Topography') + xlab('Exp-Factor') +coord_cartesian(xlim = c(-3.25,3.25))
dev.off() 
```
...
tab_model(mod1,mod2,mod3,mod4,mod5,pred.labels = c("Intercept","Age","Sex","General SES","Baseline PicVocab","Baseline Flanker","Baseline Picture","Baseline Pattern","Baseline Reading"),dv.labels=c("Picture Vocabulary","Flanker","Pic. Sequence Mem.","Pattern Comparison","Reading Recognition"),digits=2,digits.p=2,show.se=TRUE,show.stat=TRUE,string.stat = "t",string.se = "Std. Error",show.intercept=TRUE,show.ci = FALSE, p.adjust="bonferroni",p.style="scientific", file = "/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/T2NIHTBX_GeneralSES_Disc.doc")

tab_model(mod6,mod7,mod8,mod9,mod10,pred.labels = c("Intercept","Age","Sex","General SES","Baseline PicVocab","Baseline Flanker","Baseline Picture","Baseline Pattern","Baseline Reading"),dv.labels=c("Picture Vocabulary","Flanker","Pic. Sequence Mem.","Pattern Comparison","Reading Recognition"),digits=2,digits.p=2,show.se=TRUE,show.stat=TRUE,string.stat = "t",string.se = "Std. Error",show.intercept=TRUE,show.ci = FALSE, p.adjust="bonferroni",p.style="scientific", file = "/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/T2NIHTBX_GeneralSES_Rep.doc")
...
tab_model(mod1,mod2,mod3,mod4,mod5,pred.labels = c("Intercept","Age","Sex","General SES","School","Family Values","Family Turmoil","Dense Urban Poverty","Extracurriculars","Screen Time","Baseline PicVocab","Baseline Flanker","Baseline Picture","Baseline Pattern","Baseline Reading"),dv.labels=c("Picture Vocabulary","Flanker","Pic. Sequence Mem.","Pattern Comparison","Reading Recognition"),digits=2,digits.p=2,show.se=TRUE,show.stat=TRUE,string.stat = "t",string.se = "Std. Error",show.intercept=TRUE,show.ci = FALSE, p.adjust="bonferroni",p.style="scientific", file = "/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/T2NIHTBX_ExpBifactors_Disc.doc")

tab_model(mod6,mod7,mod8,mod9,mod10,pred.labels = c("Intercept","Age","Sex","General SES","School","Family Values","Family Turmoil","Dense Urban Poverty","Extracurriculars","Screen Time","Baseline PicVocab","Baseline Flanker","Baseline Picture","Baseline Pattern","Baseline Reading"),dv.labels=c("Picture Vocabulary","Flanker","Pic. Sequence Mem.","Pattern Comparison","Reading Recognition"),digits=2,digits.p=2,show.se=TRUE,show.stat=TRUE,string.stat = "t",string.se = "Std. Error",show.intercept=TRUE,show.ci = FALSE, p.adjust="bonferroni",p.style="scientific", file = "/Users/askeller/Documents/ExposomeAnalyses/LongitudinalExpScores/T2NIHTBX_ExpBifactors_Rep.doc")
...
```{r}
# calculate change in General SES and cognitive scores
...
abcd.data.disc.pfns.psych <- merge(abcd.data.disc.pfns,psych.data,by="subjectkey")
abcd.data.rep.pfns.psych <- merge(abcd.data.rep.pfns,psych.data,by="subjectkey")
