...
write.csv(abcd.data.for.ridge.complete,"/Users/askeller/Documents/ExposomeAnalyses/PFNs_ExpFactor_Ridge/PFNvsExp_Cognition/data_for_ridge_PFNandExp.csv")
write.csv(exp.data.for.ridge,"/Users/askeller/Documents/ExposomeAnalyses/PFNs_ExpFactor_Ridge/PFNvsExp_Cognition/ExpFactor_features.csv")

cog.regressed.expfactor.for.ridge <- abcd.data.for.ridge.complete
modExpCog <- lm(ExpFactor~thompson_PC1+thompson_PC2+thompson_PC3,data=cog.regressed.expfactor.for.ridge)
cog.regressed.expfactor.for.ridge$CogRegExp <- modExpCog$residuals

write.csv(cog.regressed.expfactor.for.ridge,"/Users/askeller/Documents/ExposomeAnalyses/PFNs_ExpFactor_Ridge/PFNvsExp_Cognition/data_for_ridge_cogregexp.csv")
