...
"""
phenotypes = pd.read_csv('/gpfs/fs001/cbica/projects/abcdfnets/data_for_ridge_Exp.csv') #load
...
features = []
SESfeatures = pd.read_csv('/gpfs/fs001/cbica/projects/abcdfnets/ExpFactor_features.csv') #load
