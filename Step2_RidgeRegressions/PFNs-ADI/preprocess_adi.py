...
"""
phenotypes = pd.read_csv('/gpfs/fs001/cbica/projects/abcdfnets/data_for_ridge_adi.csv') #load
...
phenotypes[['reshist_addr1_adi_income','rel_family_id','matched_group']].to_csv('/{0}/phenotypes_target.csv'.format(outdir))
