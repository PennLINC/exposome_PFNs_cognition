...
"""
os.system('python /{0}/preprocess_expfactor_sepsamp.py {1} {2}'.format(homedir,network,tmpdir))

working_dir = homedir + '/results_PFNs_ExpFactor_SepSamp/{0}_network/'.format(network)
