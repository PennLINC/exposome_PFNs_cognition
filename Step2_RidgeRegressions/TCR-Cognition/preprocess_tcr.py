...
"""
phenotypes = pd.read_csv('/gpfs/fs001/cbica/projects/abcdfnets/data_for_ridge_tcr.csv') #load
...
features = []
TCRfeaturesOrdered=phenotypes['PFN1','PFN2','PFN3','PFN4','PFN5','PFN6','PFN7','PFN8','PFN9','PFN10','PFN11','PFN12','PFN13','PFN14','PFN15','PFN16','PFN17'] 
features=np.array(TCRfeaturesOrdered)
