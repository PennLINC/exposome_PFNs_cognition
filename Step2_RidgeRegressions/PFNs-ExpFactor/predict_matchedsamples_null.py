...
np.save('/{0}/{1}_targets_null.npy'.format(working_dir,phenotype_name),targets)
...
np.save('/{0}/{1}_acc_null_testA.npy'.format(working_dir,phenotype_name),accuracy_testA)
np.save('/{0}/{1}_acc_null_testB.npy'.format(working_dir,phenotype_name),accuracy_testB)
