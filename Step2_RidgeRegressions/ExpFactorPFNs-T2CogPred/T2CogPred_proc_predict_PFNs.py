...
if phenotype_name == 'PicVocabT2':
	os.system('python /{0}/T2CogPred_preprocess_PFNs_PicVocab.py {1} {2}'.format(homedir,network,tmpdir))
elif phenotype_name == 'FlankerT2':
	os.system('python /{0}/T2CogPred_preprocess_PFNs_Flanker.py {1} {2}'.format(homedir,network,tmpdir))
elif phenotype_name == 'PictureT2':
	os.system('python /{0}/T2CogPred_preprocess_PFNs_Picture.py {1} {2}'.format(homedir,network,tmpdir))
elif phenotype_name == 'PatternT2':
	os.system('python /{0}/T2CogPred_preprocess_PFNs_Pattern.py {1} {2}'.format(homedir,network,tmpdir))
elif phenotype_name == 'ReadingT2':
	os.system('python /{0}/T2CogPred_preprocess_PFNs_Reading.py {1} {2}'.format(homedir,network,tmpdir))
else:
	print("Cognitive Task Not Implemented")

working_dir = homedir + '/results_T2CogPred_PFNs/{0}_network/'.format(network)
